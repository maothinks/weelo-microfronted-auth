# Weelo Microfrontend Auth

This microfrontend allows Sign-in and Sign-up and creates the user session with JWT Token, it is required by Ocelot Api Gateway to response the requests to microservices
